...
if __name__ == '__main__':
    ...
    for N in n_vals:
        ...
        system("~/spark/bin/spark-submit --master spark://ip-172-31-16-142.us-west-2.compute.internal:51936 --jars ~/spark/jars/elasticsearch-hadoop-2.1.0.Beta2.jar ~/es-spark-matmult/es_spark_mm.py")
